...
export class TransactionDescriptionUpdatedDomainEvent extends DomainEvent {
  static eventName = "toke.ledger.transaction.description.updated";
  ...
  constructor(
    ...
    super(TransactionDescriptionUpdatedDomainEvent.eventName, id);
  }
