...
export class TransactionDateUpdatedDomainEvent extends DomainEvent {
  static eventName = "toke.ledger.transaction.date.updated";
  ...
  constructor(
    ...
    super(TransactionDateUpdatedDomainEvent.eventName, id);
  }
