...
export class TransactionNotesUpdatedDomainEvent extends DomainEvent {
  static eventName = "toke.ledger.transaction.notes.updated";
  ...
  constructor(
    ...
    super(TransactionNotesUpdatedDomainEvent.eventName, id);
  }
